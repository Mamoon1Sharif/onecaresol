...
const Dashboard = () => {
  ...
  const statCards = [
    ...
    { title: "Active Service Users", value: String(stats?.activeCareReceivers ?? "—"), icon: HeartHandshake, iconBg: "bg-success/10", color: "text-success", borderAccent: "" },
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-muted/50 hover:bg-muted/50">
                  ...
                  <TableHead className="font-semibold text-foreground">Service User</TableHead>
        ...
        <Card className="border border-border shadow-sm">
          ...
          <CardContent className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              { label: "Add Service User", icon: HeartHandshake, to: "/carereceivers" },
