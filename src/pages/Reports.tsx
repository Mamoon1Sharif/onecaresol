...
const sections: ReportSection[] = [
  ...
  },
  {
    ...
    color: "emerald",
    items: [
      { name: "Invoice Groups", icon: Receipt },
      { name: "Wages", icon: Wallet },
      { name: "Tariffs", icon: PoundSterling },
      { name: "Funders", icon: Landmark },
      { name: "Invoice / Wages Settings", icon: Settings },
      { name: "Bank Holidays", icon: Banknote },
      { name: "Holiday Report", icon: Plane },
    ],
  },
];
